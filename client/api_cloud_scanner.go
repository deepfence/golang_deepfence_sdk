...
type ApiStartCloudComplianceScansRequest struct {
	ctx context.Context
	ApiService *CloudScannerApiService
	modelCloudComplianceScanTriggerReq *ModelCloudComplianceScanTriggerReq
}

func (r ApiStartCloudComplianceScansRequest) ModelCloudComplianceScanTriggerReq(modelCloudComplianceScanTriggerReq ModelCloudComplianceScanTriggerReq) ApiStartCloudComplianceScansRequest {
	r.modelCloudComplianceScanTriggerReq = &modelCloudComplianceScanTriggerReq
	return r
}

func (r ApiStartCloudComplianceScansRequest) Execute() (*ModelScanTriggerResp, *http.Response, error) {
	return r.ApiService.StartCloudComplianceScansExecute(r)
}

/*
StartCloudComplianceScans Start Cloud Compliance Scans

Start Cloud Compliance Scans on cloud nodes

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStartCloudComplianceScansRequest
*/
func (a *CloudScannerApiService) StartCloudComplianceScans(ctx context.Context) ApiStartCloudComplianceScansRequest {
	return ApiStartCloudComplianceScansRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CloudScannerApiService) StartCloudComplianceScansExecute(r ApiStartCloudComplianceScansRequest) (*ModelScanTriggerResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudScannerApiService.StartCloudComplianceScans")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deepfence/scan/start/cloud-compliance"
	...
	// body params
	localVarPostBody = r.modelCloudComplianceScanTriggerReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
