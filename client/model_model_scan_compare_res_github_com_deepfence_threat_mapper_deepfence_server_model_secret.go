...
func (o *ModelScanCompareResGithubComDeepfenceThreatMapperDeepfenceServerModelSecret) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varModelScanCompareResGithubComDeepfenceThreatMapperDeepfenceServerModelSecret)
