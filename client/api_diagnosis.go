...
func (r ApiGetDiagnosticLogsRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DiagnosisApiService) GetDiagnosticLogsExecute(r ApiGetDiagnosticLogsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
