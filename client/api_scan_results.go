...
func (r ApiGetAllNodesOfScanResultDocumentRequest) Execute() ([]map[string]string, *http.Response, error) {
...
func (a *ScanResultsApiService) GetAllNodesOfScanResultDocumentExecute(r ApiGetAllNodesOfScanResultDocumentRequest) ([]map[string]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetScanResultDocumentRequest struct {
	ctx context.Context
	ApiService *ScanResultsApiService
	docId string
	scanId string
...
func (r ApiGetScanResultDocumentRequest) Execute() (map[string]string, *http.Response, error) {
	return r.ApiService.GetScanResultDocumentExecute(r)
}

/*
GetScanResultDocument Get Scans Result Document
...
Get Scans Result Document
 ...
 @param scanId
 @param scanType
 @return ApiGetScanResultDocumentRequest
*/
func (a *ScanResultsApiService) GetScanResultDocument(ctx context.Context, docId string, scanId string, scanType string) ApiGetScanResultDocumentRequest {
	return ApiGetScanResultDocumentRequest{
		ApiService: a,
		ctx: ctx,
		docId: docId,
...
// Execute executes the request
//  @return map[string]string
func (a *ScanResultsApiService) GetScanResultDocumentExecute(r ApiGetScanResultDocumentRequest) (map[string]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScanResultsApiService.GetScanResultDocument")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
