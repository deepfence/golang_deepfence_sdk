...
func (r ApiAddEmailConfigurationRequest) Execute() (*http.Response, error) {
...
func (a *SettingsApiService) AddEmailConfigurationExecute(r ApiAddEmailConfigurationRequest) (*http.Response, error) {
	var (
