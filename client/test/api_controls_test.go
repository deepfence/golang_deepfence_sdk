...
func Test_client_ControlsApiService(t *testing.T) {
	...
	t.Run("Test ControlsApiService GetKubernetesScannerControls", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.ControlsApi.GetKubernetesScannerControls(context.Background()).Execute()
