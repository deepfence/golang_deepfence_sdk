...
func main() {
	modelCloudNodeAccountRegisterReq := *openapiclient.NewModelCloudNodeAccountRegisterReq("AccountId_example", "AccountName_example", "CloudProvider_example", "HostNodeId_example", "NodeId_example", "Version_example") // ModelCloudNodeAccountRegisterReq |  (optional)
