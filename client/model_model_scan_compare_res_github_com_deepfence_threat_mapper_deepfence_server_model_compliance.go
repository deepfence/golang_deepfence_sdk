...
func (o *ModelScanCompareResGithubComDeepfenceThreatMapperDeepfenceServerModelCompliance) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varModelScanCompareResGithubComDeepfenceThreatMapperDeepfenceServerModelCompliance)
