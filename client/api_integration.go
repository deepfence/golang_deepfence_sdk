...
func (r ApiAddIntegrationRequest) Execute() (*http.Response, error) {
...
func (a *IntegrationApiService) AddIntegrationExecute(r ApiAddIntegrationRequest) (*http.Response, error) {
	var (
