...
/*
GetUserActivityLogs Get activity logs for all users
...
*/
func (a *UserApiService) GetUserActivityLogs(ctx context.Context) ApiGetUserActivityLogsRequest {
	return ApiGetUserActivityLogsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *UserApiService) GetUserActivityLogsExecute(r ApiGetUserActivityLogsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserApiService.GetUserActivityLogs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deepfence/user-activity-log"
