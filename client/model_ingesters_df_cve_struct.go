...
// checks if the IngestersDfCveStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IngestersDfCveStruct{}
...
func (o IngestersDfCveStruct) ToMap() (map[string]interface{}, error) {
