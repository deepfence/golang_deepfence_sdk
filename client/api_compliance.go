...
func (a *ComplianceAPIService) CountResultsComplianceScanExecute(r ApiCountResultsComplianceScanRequest) (*SearchSearchCountResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/results/count/compliance"
...
type ApiGroupResultsCloudComplianceRequest struct {
	ctx context.Context
	ApiService *ComplianceAPIService
	modelComplinaceScanResultsGroupReq *ModelComplinaceScanResultsGroupReq
}

func (r ApiGroupResultsCloudComplianceRequest) ModelComplinaceScanResultsGroupReq(modelComplinaceScanResultsGroupReq ModelComplinaceScanResultsGroupReq) ApiGroupResultsCloudComplianceRequest {
	r.modelComplinaceScanResultsGroupReq = &modelComplinaceScanResultsGroupReq
	return r
}
...
/*
GroupResultsCloudCompliance Count Cloud Compliance Results by Control ID

Count Cloud Compliance Results grouped by Control ID

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupResultsCloudComplianceRequest
*/
func (a *ComplianceAPIService) GroupResultsCloudCompliance(ctx context.Context) ApiGroupResultsCloudComplianceRequest {
	return ApiGroupResultsCloudComplianceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ComplianceAPIService) GroupResultsCloudComplianceExecute(r ApiGroupResultsCloudComplianceRequest) (*ModelComplianceScanResultsGroupResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/results/count/group/cloud-compliance"
	...
	// body params
	localVarPostBody = r.modelComplinaceScanResultsGroupReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGroupResultsComplianceRequest struct {
	ctx context.Context
	ApiService *ComplianceAPIService
	modelComplinaceScanResultsGroupReq *ModelComplinaceScanResultsGroupReq
}

func (r ApiGroupResultsComplianceRequest) ModelComplinaceScanResultsGroupReq(modelComplinaceScanResultsGroupReq ModelComplinaceScanResultsGroupReq) ApiGroupResultsComplianceRequest {
	r.modelComplinaceScanResultsGroupReq = &modelComplinaceScanResultsGroupReq
	return r
}
...
/*
GroupResultsCompliance Count Compliance Results by Control ID

Count Compliance Results grouped by Control ID

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupResultsComplianceRequest
*/
func (a *ComplianceAPIService) GroupResultsCompliance(ctx context.Context) ApiGroupResultsComplianceRequest {
	return ApiGroupResultsComplianceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ComplianceAPIService) GroupResultsComplianceExecute(r ApiGroupResultsComplianceRequest) (*ModelComplianceScanResultsGroupResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/results/count/group/compliance"
...
func (a *ComplianceAPIService) IngestComplianceScanStatusExecute(r ApiIngestComplianceScanStatusRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/ingest/compliance-scan-logs"
...
func (a *ComplianceAPIService) ListComplianceScanExecute(r ApiListComplianceScanRequest) (*ModelScanListResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/list/compliance"
...
func (a *ComplianceAPIService) StartComplianceScanExecute(r ApiStartComplianceScanRequest) (*ModelScanTriggerResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/start/compliance"
...
func (a *ComplianceAPIService) StatusComplianceScanExecute(r ApiStatusComplianceScanRequest) (*ModelScanStatusResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/status/compliance"
...
func (a *ComplianceAPIService) StopComplianceScanExecute(r ApiStopComplianceScanRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/deepfence/scan/stop/compliance"
