...
// checks if the IngestersComplianceDoc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IngestersComplianceDoc{}
...
func (o IngestersComplianceDoc) ToMap() (map[string]interface{}, error) {
