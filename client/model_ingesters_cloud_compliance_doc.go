...
// checks if the IngestersCloudComplianceDoc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IngestersCloudComplianceDoc{}

// IngestersCloudComplianceDoc struct for IngestersCloudComplianceDoc
type IngestersCloudComplianceDoc struct {
...
func NewIngestersCloudComplianceDoc() *IngestersCloudComplianceDoc {
	this := IngestersCloudComplianceDoc{}
	return &this
}
...
func (o *IngestersCloudComplianceDoc) GetDocId() string {
...
// and a boolean to check if the value has been set.
func (o *IngestersCloudComplianceDoc) GetServiceOk() (*string, bool) {
	if o == nil || isNil(o.Service) {
		return nil, false
	}
...
func (o *IngestersCloudComplianceDoc) SetStatus(v string) {
	o.Status = &v
}
...
func (o IngestersCloudComplianceDoc) MarshalJSON() ([]byte, error) {
...
func (o IngestersCloudComplianceDoc) ToMap() (map[string]interface{}, error) {
...
type NullableIngestersCloudComplianceDoc struct {
	value *IngestersCloudComplianceDoc
	isSet bool
}

func (v NullableIngestersCloudComplianceDoc) Get() *IngestersCloudComplianceDoc {
	return v.value
}

func (v *NullableIngestersCloudComplianceDoc) Set(val *IngestersCloudComplianceDoc) {
	v.value = val
	v.isSet = true
}

func (v NullableIngestersCloudComplianceDoc) IsSet() bool {
	return v.isSet
}

func (v *NullableIngestersCloudComplianceDoc) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIngestersCloudComplianceDoc(val *IngestersCloudComplianceDoc) *NullableIngestersCloudComplianceDoc {
	return &NullableIngestersCloudComplianceDoc{value: val, isSet: true}
}

func (v NullableIngestersCloudComplianceDoc) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIngestersCloudComplianceDoc) UnmarshalJSON(src []byte) error {
	v.isSet = true
